...
# Objective: Minimize the maximum difference in travel distances
...
subject to MaxDiffConstraint {t1 in TEAMS, t2 in TEAMS: t1 != t2}:
    travel[t1] - travel[t2] <= small;

subject to MaxDiffConstraintAbs {t1 in TEAMS, t2 in TEAMS: t1 != t2}:
    travel[t2] - travel[t1] <= small;
